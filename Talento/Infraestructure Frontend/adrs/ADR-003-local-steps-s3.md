---
title: "ADR-003: Pasos LOCAL — Railway Volumes + S3/B2"
status: accepted
date: 2026-06-14
---

# ADR-003: Pasos LOCAL — Railway Volumes + S3/B2
...
**Estrategia híbrida: Railway Volume como staging + S3/B2 como destino final**
...
- El destino final de backups y artefactos siempre es S3/Backblaze B2
- El Volume es opcional: si no está presente, los steps LOCAL usan `/tmp` (efímero) y el usuario debe asegurar que el resultado final vaya a S3/B2
...
- Positivas: los backups van a S3/B2 desde el origen (3-2-1 rule)
